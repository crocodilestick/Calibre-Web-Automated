...
| Hungarian (`hu`) | `███████████████████░` 94% | 1584/1682 | 63 |
| French (`fr`) | `██████████████████░░` 91% | 1525/1682 | 75 |
| Japanese (`ja`) | `██████████████████░░` 91% | 1525/1682 | 201 |
| Spanish (`es`) | `██████████████████░░` 91% | 1524/1682 | 242 |
| German (`de`) | `██████████████████░░` 90% | 1514/1682 | 87 |
| Slovenian (`sl`) | `██████████████████░░` 89% | 1502/1682 | 284 |
| Russian (`ru`) | `███████████████░░░░░` 74% | 1251/1682 | 435 |
| Dutch (`nl`) | `███████████████░░░░░` 73% | 1232/1682 | 259 |
| Italian (`it`) | `██████████████░░░░░░` 71% | 1194/1682 | 235 |
| Polish (`pl`) | `██████████████░░░░░░` 71% | 1194/1682 | 240 |
| Portuguese (Brazil) (`pt_BR`) | `██████████████░░░░░░` 71% | 1194/1682 | 368 |
| Korean (`ko`) | `██████████████░░░░░░` 71% | 1188/1682 | 235 |
| Chinese (Simplified, China) (`zh_Hans_CN`) | `██████████████░░░░░░` 69% | 1160/1682 | 319 |
| Arabic (`ar`) | `████████████░░░░░░░░` 62% | 1049/1682 | 256 |
| Portuguese (`pt`) | `████████████░░░░░░░░` 62% | 1037/1682 | 334 |
| Slovak (`sk`) | `████████████░░░░░░░░` 62% | 1038/1682 | 286 |
| Indonesian (`id`) | `████████████░░░░░░░░` 60% | 1017/1682 | 336 |
| Galician (`gl`) | `████████████░░░░░░░░` 60% | 1015/1682 | 335 |
| Chinese (Traditional, Taiwan) (`zh_Hant_TW`) | `████████████░░░░░░░░` 58% | 975/1682 | 355 |
| Swedish (`sv`) | `███████████░░░░░░░░░` 57% | 952/1682 | 365 |
| Greek (`el`) | `███████████░░░░░░░░░` 53% | 888/1682 | 379 |
| Czech (`cs`) | `██████████░░░░░░░░░░` 52% | 868/1682 | 388 |
| Norwegian (`no`) | `██████████░░░░░░░░░░` 51% | 853/1682 | 422 |
| Vietnamese (`vi`) | `█████████░░░░░░░░░░░` 46% | 772/1682 | 348 |
| Finnish (`fi`) | `█████████░░░░░░░░░░░` 44% | 735/1682 | 378 |
| Ukrainian (`uk`) | `████████░░░░░░░░░░░░` 40% | 669/1682 | 365 |
| Turkish (`tr`) | `████████░░░░░░░░░░░░` 39% | 663/1682 | 373 |
| Khmer (`km`) | `███████░░░░░░░░░░░░░` 33% | 548/1682 | 339 |
