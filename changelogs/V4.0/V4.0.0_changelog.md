...
- **Dutch** (nl) - Significant contributions from **[jordibrouwer](https://github.com/jordibrouwer)** & **[helmerzNL](https://github.com/helmerzNL)**!
...
- A brand new Svelte based Frontend. The days of the current Bootstrap UI are numbers and migrating to Svelte ensures that the enw UI will still be easy to adit and add to for more contributors due to it's very familiar syntax to traditional sites and can be compiled with Capacitor for native mobile apps which is very exiting
