...
def HandleSyncRequest():
    ...
    for book in books:
        ...
        sync_results.append({"ChangedProductMetadata": get_metadata(book.Books)}) # Added fix for updated metadata & covers not reliably updating on Kobo devices. Courtesy of @tsheinen
