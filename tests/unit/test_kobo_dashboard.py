...
from cps.kobo_dashboard import get_magic_shelf_book_ids_direct, get_kobo_dashboard_data
...
class TestKoboDashboard:
    ...
    def test_get_kobo_dashboard_data_basic(self, mock_session, mock_allowed_books, mock_magic_ids, mock_config):
    ...
    @patch('cps.kobo.get_kobo_allowed_book_ids')
    @patch('cps.ub.session')
    def test_get_kobo_dashboard_data_warnings(self, mock_session, mock_allowed_books, mock_magic_ids, mock_config):
